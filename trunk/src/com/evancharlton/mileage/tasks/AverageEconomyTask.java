...
public class AverageEconomyTask extends
    ...
    public void onProgressUpdate(Integer... update) {
        Toast.makeText(getParent().getContext(),
                getParent().getContext().getString(R.string.toast_calculating_avg_economy),
                Toast.LENGTH_SHORT)
                .show();
    }
    ...
    public Double doInBackground(Vehicle... vehicles) {
        ...
        Cursor cursor = mContentResolver.query(FillupsTable.BASE_URI, FillupsTable.PROJECTION,
